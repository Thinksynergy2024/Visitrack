...
const VisitorsLocationGraphIn = ( { visits }) => {


  // Filter visitors with status 'Out'
  const filteredVisitors = visits.filter((visitor) => visitor.visitorstatus === "In");
  ...
  const [options, setOptions] = useState({
    ...
    title: {
      text: 'Visitors by Location (Status: In)'
    },
    xAxis: {
...
export default VisitorsLocationGraphIn;
